            ...
            <div class="row_input_group_3">
                <div class="input_group">
                    ...
                    <div class="custom_radio_buttons">
                        <label>
                            <input class="option_radio" type="radio" name="is_featured" id="yes" value="1" {{ old('is_featured', 1) == '1' ? 'checked' : '' }}>
                            <span>Yes</span>
                        </label>
    
                        <label>
                            <input class="option_radio" type="radio" name="is_featured" id="no" value="0" {{ old('is_featured', 0) == '0' ? 'checked' : '' }}>
                            <span>No</span>
                        </label>
                    </div>
